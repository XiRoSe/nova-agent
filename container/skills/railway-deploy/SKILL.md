---
name: railway-deploy
description: Build and deploy applications to Railway — create services, set env vars, generate domains, add databases. Use when deploying an app or managing Railway infrastructure.
---
