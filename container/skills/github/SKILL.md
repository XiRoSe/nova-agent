---
name: github
description: Read and write the user's GitHub — clone, read, edit, and push repos, and use the API for repos, branches, issues, and pull requests. Use for any GitHub repo/issue/PR/code task, or to connect GitHub.
---
