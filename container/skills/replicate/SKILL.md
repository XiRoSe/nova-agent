---
name: replicate
description: Access 9,000+ AI models via Replicate — image generation, vision analysis, audio transcription, video generation, OCR, and background removal. Use for multimodal or generative AI tasks.
---
