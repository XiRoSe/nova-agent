...
description: Read and manage the user's Google Calendar — list events, check availability, create/move/update/delete events. Use for calendar questions, scheduling, or connecting Google.
---
