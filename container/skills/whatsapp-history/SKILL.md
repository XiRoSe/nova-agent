...
description: Query message history from any registered WhatsApp group or chat via the SQLite DB. Use to fetch, search, or summarize messages from a WhatsApp group or chat.
---
